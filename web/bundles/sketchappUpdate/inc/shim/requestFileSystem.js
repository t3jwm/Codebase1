...
// 	}
	...
	// TODO: FF 13+ support DOM4 Events (DOMError). Use them instead?
	...
	function MyFile(opts) {
		...
		this.name = opts.name || '';
		this.type = opts.type || '';
		this.lastModifiedDate = opts.lastModifiedDate || new Date();
		...
		Object.defineProperty(this, 'blob_', {
			...
			set: function(val) {
				...
				this.name = blob_.name || opts.name;
				this.type = blob_.type || opts.type;
