  ...
  $.fn.perfectScrollbar = function (suppliedSettings, option) {
    ...
    return this.each(function () {
      ...
      if ($this.data('perfect-scrollbar')) {
        ...
        if ($this.data('perfect-scrollbar').context.querySelector(".ps-scrollbar-y")) {
      ...
      var updateScrollbarCss = function () {
        ...
        if (contentHeight - containerHeight === 0) {
          $scrollbarYRail.css({display: "none"});
        }
        if (contentWidth - containerWidth === 0) {
          $scrollbarXRail.css({display: "none"});
        }
      };

      var updateBarSizeAndPosition = function () {
        containerWidth = Math.min($this.width(), settings.maxWidth);
        containerHeight = Math.min($this.height(), settings.maxHeight);
        ...
        if (!settings.suppressScrollX && containerWidth + settings.scrollXMarginOffset < contentWidth) {
          ...
          scrollbarXLeft = parseInt($this.scrollLeft() * (containerWidth - scrollbarXWidth) / (contentWidth - $this.width()), 10);
        }
        else {
        ...
        if (!settings.suppressScrollY && containerHeight + settings.scrollYMarginOffset < contentHeight) {
          ...
          scrollbarYTop = parseInt($this.scrollTop() * (containerHeight - scrollbarYHeight) / (contentHeight - $this.height()), 10);
        }
        else {
